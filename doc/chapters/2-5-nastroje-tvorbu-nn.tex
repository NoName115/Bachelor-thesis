...
Aj keď sa snaží implementáciu zjednodušiť, stále si zachováva modularitu a preto je možné dostatočne dobre modely neurónových sietí upravovať a prisposobovať pre riešienie rôznych problémov \cite{odkaz:Keras}.
