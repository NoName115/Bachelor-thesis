...
\begin{enumerate}
    ...
    Použitím väčších skokov bude výsledna aktivačná mapa menšia.
...
V prípade typu Max Pooling s veľkosťou filtra 2x2 sa zoberú 4 hodnoty z aktivačnej mapy a vyberie sa z nich maximálna, podobným spôsobom
    fungujú aj ostatné typy zlučovania, ale výsledna hodnota je napr. priemer alebo suma týchto 4 hodnôt.
